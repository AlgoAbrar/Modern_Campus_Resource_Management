      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <Tabs value={selectedTab} onValueChange={setSelectedTab} className="mb-8">
          <TabsList className="grid w-full max-w-md mx-auto grid-cols-2">
            <TabsTrigger value="paranoma" className="flex items-center gap-2">
              <Building className="h-4 w-4" />
              Paranoma (Student Rooms)
            </TabsTrigger>
            <TabsTrigger value="nexas" className="flex items-center gap-2">
              ...
              {(() => {
                ...
                return (
                  <>
                    ...
                    <Badge variant="outline" className="text-sm py-1 px-3 bg-green-50 text-green-700">
                      Empty: {stats.empty}
                    </Badge>
                    <Badge variant="outline" className="text-sm py-1 px-3 bg-red-50 text-red-700">
                      In Use: {stats.inUse}
                    </Badge>
                  </>
                );
